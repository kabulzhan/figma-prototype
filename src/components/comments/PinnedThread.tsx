...
import { ThreadMetadata } from "#root/liveblocks.config";
...
export const PinnedThread = ({ thread, onFocus, ...props }: Props) => {
  ...
  const memoizedContent = useMemo(
    () => (
      ...
      >
        <div
          className="relative flex h-9 w-9 select-none items-center justify-center rounded-bl-full rounded-br-full rounded-tl-md
