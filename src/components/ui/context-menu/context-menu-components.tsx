...
const ContextMenuWrapper = ContextMenuPrimitive.Root;
  ...
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ...
      className={cn(
        ...
        data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] overflow-hidden rounded-md border
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ref={ref}
    className={cn(
      `space-be relative flex cursor-default select-none items-center justify-between rounded-sm px-2
